defmodule PhoenixTCP.Serializers.HubProtocol do
  ...
  # 4-header-U32 : 4-(name-size)-U32 : 
  # (name-size)-name-String : 4-(category-size)-U32 : 
  # (category-size)-category-String : [65 8-byte latency values as U64s] : 
  ...
  defp payload_decode(<< _header :: size(32), name_size :: size(32),
    ...
    category :: binary-size(category_size), bin_0 :: unsigned-integer-size(64),
